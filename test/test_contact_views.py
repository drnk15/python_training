...
def test_contact_on_homepage(app):
    ...
    assert clear(contact_from_homepage.all_emails) == clear(contact_from_edit_page.all_emails)
    assert clear(contact_from_homepage.all_phones) == clear(contact_from_edit_page.all_phones)
